...
export default function FmsHubPage() {
  ...
  const allItems = [
    ...
    { label: "Forms", to: "/admin/fms/forms", desc: "Access the form builder and forms list" },
  ];
    ...
    <div style={{ padding: "32px 40px", maxWidth: 1200, margin: "0 auto" }}>
      <div style={{ marginBottom: 40 }}>
        <h1 style={{ 
          ...
          Welcome to FMS Module
        </h1>
        <p style={{ color: "#64748b", fontSize: 16, maxWidth: 600, lineHeight: 1.5 }}>
          Access all FMS module tools and features below.
        </p>
      </div>
