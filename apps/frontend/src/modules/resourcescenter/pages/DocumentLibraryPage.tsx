...
const EMPTY_FORM = {
  title: "",
  category: "qc_format" as DocumentCategory,
  description: "",
  expiryDate: "",
    ...
    <div style={{ fontFamily: "-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif" }}>
      ...
      <div style={{ marginBottom: 24 }}>
        ...
        <p style={{ fontSize: 13, color: "#6b7280", marginTop: 4 }}>
          Upload and manage all organizational documents in one place.
        </p>
      </div>
      ...
      {tab === "upload" && (
        <div style={{ maxWidth: 560 }}>
          ...
          <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: 16 }}>
            ...
            {/* Expiry Date */}
            <div>
              <label style={labelStyle}>Expiry Date <span style={{ color: "#9ca3af", fontWeight: 400 }}>(optional)</span></label>
              <input
                type="date"
              ...
              <table style={{ width: "100%", borderCollapse: "collapse", fontSize: 13.5 }}>
                <thead>
                  <tr style={{ background: "#f9fafb", borderBottom: "1px solid #e5e7eb" }}>
                    {["#", "Title", "Attachment", "Category", "Expiry", "Last Updated", "Actions"].map((h) => (
