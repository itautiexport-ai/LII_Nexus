    ...
    <div style={{ fontFamily: "-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif" }}>
      ...
      <div style={{ marginBottom: 24 }}>
        ...
        <p style={{ fontSize: 13, color: "#6b7280", marginTop: 4 }}>
          Upload and manage company policies and guidelines.
        </p>
      </div>
      ...
      <div style={{ display: "flex", borderBottom: "2px solid #e5e7eb", marginBottom: 28, gap: 0 }}>
        {(["upload", "list"] as Tab[]).map((t) => {
          const labels: Record<Tab, string> = { upload: "📤  Upload Policy", list: "📋  List of Policies" };
          const active = tab === t;
          return (
            <button
              key={t}
      ...
      {tab === "upload" && (
        <div style={{ maxWidth: 560 }}>
          ...
          <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: 16 }}>
            ...
            {/* Title */}
            <div>
              <label style={labelStyle}>Policy Title <span style={{ color: "#ef4444" }}>*</span></label>
              <input
                required
                value={form.title}
            ...
            <div>
              ...
              <textarea
                ...
                rows={3}
                placeholder="Brief notes about this policy..."
      ...
      {tab === "list" && (
        <div>
          ...
          {/* Table */}
          {loading ? (
            <div style={{ textAlign: "center", padding: "40px 0", color: "#9ca3af", fontSize: 14 }}>Loading policies…</div>
          ) : docs.length === 0 ? (
