  ...
  return (
    <div style={containerStyle}>
      <div style={headerStyle}>
        <h1 style={titleStyle}>CAPA & Resolution (CQA)</h1>
        <button 
          style={buttonStyle(true)} 
          onClick={() => navigate("/admin/crm/capa/new")}
      ...
      <div style={emptyCardStyle}>
        <h2 style={{ margin: "0 0 8px 0", color: "#374151" }}>CAPA Module</h2>
        <p style={{ margin: 0, fontSize: "15px" }}>Click "New CAPA" to record Corrective/Preventive actions and Resolutions.</p>
      </div>
    </div>
  );
}
