...
router.delete("/fms/:id", authMiddleware, requireAdmin(), controller.deleteFms);
...
router.delete("/fms/steps/:stepId", authMiddleware, requireAdmin(), controller.deleteStep);
...
router.delete("/fms/instances/:instanceId", authMiddleware, requireAdmin(), execController.deleteInstance);
