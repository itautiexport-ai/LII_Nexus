...
exports.ExpiryAlertService = void 0;
...
class ExpiryAlertService {
    ...
    async checkExpiries(withinDays = 30) {
        ...
        for (const doc of expiring) {
            if (!doc.ownerId)
                continue;
            const [userRows] = await connection_1.pool.query("SELECT user_id FROM employees WHERE id = ?", [doc.ownerId]);
...
exports.ExpiryAlertService = ExpiryAlertService;
//# sourceMappingURL=ExpiryAlertService.js.map