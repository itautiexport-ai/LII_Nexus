...
exports.MOMExportService = void 0;
const pdfkit_1 = __importDefault(require("pdfkit"));
class MOMExportService {
    async toPdfBuffer(mom) {
        return new Promise((resolve, reject) => {
            ...
            if (mom.agenda.length === 0)
                doc.text("No agenda items recorded.");
            doc.moveDown();
            ...
            if (mom.decisions.length === 0)
                doc.text("No decisions recorded.");
            doc.moveDown();
            ...
            if (mom.actions.length === 0)
                doc.text("No actions recorded.");
            doc.moveDown();
...
exports.MOMExportService = MOMExportService;
//# sourceMappingURL=MOMExportService.js.map